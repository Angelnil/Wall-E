...
@property (nonatomic, assign) UIEdgeInsets priorInset;//之前的edgeInset
@property (nonatomic, assign) UIEdgeInsets priorScrollIndicatorInsets;//
@property (nonatomic, assign) BOOL         keyboardVisible;//键盘可见
@property (nonatomic, assign) CGRect       keyboardRect;//键盘的rect
@property (nonatomic, assign) CGSize       priorContentSize;//之前的scrollView 的contentSize
@end
